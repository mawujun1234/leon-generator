...
//		}
		...
		List<File> files=FileUtils.findFiles(FileUtils.getCurrentClassPath(this)+"/templates/ftl1", "*.ftl");
...
//			throw new FileExistsException(file);
	...
	public  void generator(Class clazz,String ftl,Object extenConfig,Writer writer) throws TemplateException, IOException {
		...
		//templete.setOutputEncoding("UTF-8");
		/* 创建数据模型 */
		SubjectRoot root =javaEntityMetaDataService.initPropertyColumn(clazz);
//		if(extenConfig!=null){
//			root.setExtenConfig(extenConfig);
//		}
//		
